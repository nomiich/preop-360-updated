        ...
        <div>
          ...
          <div>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button className="inline-flex items-center justify-center gap-3 rounded-lg bg-bg-slate-soft px-7 py-3 text-sm font-normal text-text transition-colors hover:bg-bg-slate-light hover:text-text">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
